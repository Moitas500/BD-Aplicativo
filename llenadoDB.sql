...
INSERT ALL
    ...
    INTO Deporte(IDDEPORTE, NOMDEPORTE) VALUES ('5', 'Voleivol')
...
-- Incluir 10 estudiantes de diferentes sedes FALTAN 10 ESTUDAINTES SEDE 3 Y 4
INSERT ALL
    ...
    into Estudiante (CODESTUDIANTE, CODESPACIO, NOMESTUDIANTE, APELESTUDIANTE, FECHAREGESTUDIANTE, CORREOUDESTUDIANTE, FECHANACESTUDIANTE) VALUES ('20211020006','2','Lee','Carrasco',TO_DATE('01/11/2014', 'dd/mm/yyyy'),'dignissim@udistrital.edu.co',TO_DATE('19/12/2000', 'dd/mm/yyyy'))
    into Estudiante (CODESTUDIANTE, CODESPACIO, NOMESTUDIANTE, APELESTUDIANTE, FECHAREGESTUDIANTE, CORREOUDESTUDIANTE, FECHANACESTUDIANTE) VALUES ('20211020007','2','Orli','Matilde',TO_DATE('02/08/2017', 'dd/mm/yyyy'),'pede.nonummy@udistrital.edu.co',TO_DATE('17/01/1996', 'dd/mm/yyyy'))
    into Estudiante (CODESTUDIANTE, CODESPACIO, NOMESTUDIANTE, APELESTUDIANTE, FECHAREGESTUDIANTE, CORREOUDESTUDIANTE, FECHANACESTUDIANTE) VALUES ('20211020008','2','Raymond','Vega',TO_DATE('06/11/2018', 'dd/mm/yyyy'),'quisque@udistrital.edu.co',TO_DATE('22/02/1996', 'dd/mm/yyyy'))
    into Estudiante (CODESTUDIANTE, CODESPACIO, NOMESTUDIANTE, APELESTUDIANTE, FECHAREGESTUDIANTE, CORREOUDESTUDIANTE, FECHANACESTUDIANTE) VALUES ('20211020009','2','Carlos','Ignacio',TO_DATE('16/10/2020', 'dd/mm/yyyy'),'senectus.et@udistrital.edu.co',TO_DATE('03/02/1996', 'dd/mm/yyyy'))
    into Estudiante (CODESTUDIANTE, CODESPACIO, NOMESTUDIANTE, APELESTUDIANTE, FECHAREGESTUDIANTE, CORREOUDESTUDIANTE, FECHANACESTUDIANTE) VALUES ('20211020010','2','Aidan','Diem',TO_DATE('12/02/2020', 'dd/mm/yyyy'),'iaculis.odio@udistrital.edu.co',TO_DATE('08/01/1998', 'dd/mm/yyyy'))
SELECT * FROM dual;

-- Incluir registros para la programación: 4 registros de cursos, 4 registros de equipos entrenamiento, 4 registros practica libre FALTAN PARA SEDE 3 Y 4
INSERT ALL
...
INSERT ALL
    INTO espacio___deporte(IDDEPORTE, CODESPACIO) VALUES ('', '')
    INTO espacio___deporte(IDDEPORTE, CODESPACIO) VALUES ('', '')
    INTO espacio___deporte(IDDEPORTE, CODESPACIO) VALUES ('', '')
    INTO espacio___deporte(IDDEPORTE, CODESPACIO) VALUES ('', '')
    INTO espacio___deporte(IDDEPORTE, CODESPACIO) VALUES ('', '')
...
INSERT ALL
    INTO ElemenDeprotivo(CONSECELEMENTO, IDESTADO, IDTIPOELEMENTO, IDMARCA, CODESPACIO, FECHAREGISTRO) VALUES (1, '1', ,)
    INTO ElemenDeprotivo(CONSECELEMENTO, IDESTADO, IDTIPOELEMENTO, IDMARCA, CODESPACIO, FECHAREGISTRO) VALUES (2, '1', ,)
    INTO ElemenDeprotivo(CONSECELEMENTO, IDESTADO, IDTIPOELEMENTO, IDMARCA, CODESPACIO, FECHAREGISTRO) VALUES (3, '1', ,)
    INTO ElemenDeprotivo(CONSECELEMENTO, IDESTADO, IDTIPOELEMENTO, IDMARCA, CODESPACIO, FECHAREGISTRO) VALUES (4, '1', ,)
    INTO ElemenDeprotivo(CONSECELEMENTO, IDESTADO, IDTIPOELEMENTO, IDMARCA, CODESPACIO, FECHAREGISTRO) VALUES (5, '1', ,)
    INTO ElemenDeprotivo(CONSECELEMENTO, IDESTADO, IDTIPOELEMENTO, IDMARCA, CODESPACIO, FECHAREGISTRO) VALUES (6, '1', ,)
    INTO ElemenDeprotivo(CONSECELEMENTO, IDESTADO, IDTIPOELEMENTO, IDMARCA, CODESPACIO, FECHAREGISTRO) VALUES (7, '1', ,)
    INTO ElemenDeprotivo(CONSECELEMENTO, IDESTADO, IDTIPOELEMENTO, IDMARCA, CODESPACIO, FECHAREGISTRO) VALUES (8, '1', ,)
    INTO ElemenDeprotivo(CONSECELEMENTO, IDESTADO, IDTIPOELEMENTO, IDMARCA, CODESPACIO, FECHAREGISTRO) VALUES (9, '1', ,)
    INTO ElemenDeprotivo(CONSECELEMENTO, IDESTADO, IDTIPOELEMENTO, IDMARCA, CODESPACIO, FECHAREGISTRO) VALUES (10, '1', ,)
SELECT * FROM dual;


-- Los equipos le falta el id del empleado encargado y la fecha 
INSERT ALL
    INTO Equipo(CONSEEQUIPO, IDDEPORTE, CODEMPLEADO, FECHARESOL) VALUES (1, '1', ,)
    INTO Equipo(CONSEEQUIPO, IDDEPORTE, CODEMPLEADO, FECHARESOL) VALUES (2, '3', ,)
    INTO Equipo(CONSEEQUIPO, IDDEPORTE, CODEMPLEADO, FECHARESOL) VALUES (3, '4', ,)
    INTO Equipo(CONSEEQUIPO, IDDEPORTE, CODEMPLEADO, FECHARESOL) VALUES (4, '5', ,)
    INTO Equipo(CONSEEQUIPO, IDDEPORTE, CODEMPLEADO, FECHARESOL) VALUES (5, '6', ,)
    INTO Equipo(CONSEEQUIPO, IDDEPORTE, CODEMPLEADO, FECHARESOL) VALUES (6, '7', ,)
    INTO Equipo(CONSEEQUIPO, IDDEPORTE, CODEMPLEADO, FECHARESOL) VALUES (7, '9', ,)
    INTO Equipo(CONSEEQUIPO, IDDEPORTE, CODEMPLEADO, FECHARESOL) VALUES (8, '10', ,)
    INTO Equipo(CONSEEQUIPO, IDDEPORTE, CODEMPLEADO, FECHARESOL) VALUES (9, '11', ,)
    INTO Equipo(CONSEEQUIPO, IDDEPORTE, CODEMPLEADO, FECHARESOL) VALUES (10, '12', ,)
SELECT * FROM dual;
