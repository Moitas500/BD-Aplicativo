...
INSERT ALL
    ...
    into Estudiante (CODESTUDIANTE, CODESPACIO, NOMESTUDIANTE, APELESTUDIANTE, FECHAREGESTUDIANTE, CORREOUDESTUDIANTE, FECHANACESTUDIANTE) VALUES ('20211020004','3','Harper','Valenzuela',TO_DATE('15/04/2015', 'dd/mm/yyyy'),'vel.nisl@udistrital.edu.co',TO_DATE('07/07/1995', 'dd/mm/yyyy'))
    into Estudiante (CODESTUDIANTE, CODESPACIO, NOMESTUDIANTE, APELESTUDIANTE, FECHAREGESTUDIANTE, CORREOUDESTUDIANTE, FECHANACESTUDIANTE) VALUES ('20211020005','3','Thor','Castro',TO_DATE('24/12/2014', 'dd/mm/yyyy'),'tempor.augue@udistrital.edu.co',TO_DATE('23/12/2001', 'dd/mm/yyyy'))
    ...
    into Estudiante (CODESTUDIANTE, CODESPACIO, NOMESTUDIANTE, APELESTUDIANTE, FECHAREGESTUDIANTE, CORREOUDESTUDIANTE, FECHANACESTUDIANTE) VALUES ('20211020007','4','Orli','Matilde',TO_DATE('02/08/2017', 'dd/mm/yyyy'),'pede.nonummy@udistrital.edu.co',TO_DATE('17/01/1996', 'dd/mm/yyyy'))
    into Estudiante (CODESTUDIANTE, CODESPACIO, NOMESTUDIANTE, APELESTUDIANTE, FECHAREGESTUDIANTE, CORREOUDESTUDIANTE, FECHANACESTUDIANTE) VALUES ('20211020008','4','Raymond','Vega',TO_DATE('06/11/2018', 'dd/mm/yyyy'),'quisque@udistrital.edu.co',TO_DATE('22/02/1996', 'dd/mm/yyyy'))
    into Estudiante (CODESTUDIANTE, CODESPACIO, NOMESTUDIANTE, APELESTUDIANTE, FECHAREGESTUDIANTE, CORREOUDESTUDIANTE, FECHANACESTUDIANTE) VALUES ('20211020009','4','Carlos','Ignacio',TO_DATE('16/10/2020', 'dd/mm/yyyy'),'senectus.et@udistrital.edu.co',TO_DATE('03/02/1996', 'dd/mm/yyyy'))
    into Estudiante (CODESTUDIANTE, CODESPACIO, NOMESTUDIANTE, APELESTUDIANTE, FECHAREGESTUDIANTE, CORREOUDESTUDIANTE, FECHANACESTUDIANTE) VALUES ('20211020010','4','Aidan','Diem',TO_DATE('12/02/2020', 'dd/mm/yyyy'),'iaculis.odio@udistrital.edu.co',TO_DATE('08/01/1998', 'dd/mm/yyyy'))
SELECT * FROM dual;
